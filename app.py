...
def doCalcUpdate(calcData, form_data):
    ...
    try:
        ...
        pass
    try:
        pushParam(calcData.beam, "beam_view_from", lambda: int(form_data.get("DiodeViewFrom")))
        pushParam(calcData.beam, "beam_view_to", lambda: int(form_data.get("DiodeViewTo")))
        pushParam(calcData.beam, "calculation_rounds", lambda: int(form_data.get("DiodeRounds")))
        pushParam(calcData.beam, "diode_pulse_width", lambda: float(form_data.get("DiodePulseWidth")))
        pushParam(calcData.beam, "diode_alpha", lambda: float(form_data.get("DiodeAlpha")))
        pushParam(calcData.beam, "diode_gamma0", lambda: float(form_data.get("DiodeGamma0")))
        pushParam(calcData.beam, "diode_saturation", lambda: float(form_data.get("DiodeSaturation")))
        pushParam(calcData.beam, "absorber_half_time", lambda: float(form_data.get("AbsorberHalfTime")))
        pushParam(calcData.beam, "gain_half_time", lambda: float(form_data.get("GainHalfTime")))
        pushParam(calcData.beam, "diode_absorber_shift", lambda: float(form_data.get("DiodeAbsorberShift")))
        pushParam(calcData.beam, "diode_gain_shift", lambda: float(form_data.get("DiodeGainShift")))
        pushParam(calcData.beam, "diode_output_coupler_shift", lambda: float(form_data.get("DiodeOutputCouplerShift")))

        pushParam(calcData.beam, "gain_width", lambda: float(form_data.get("gain_width")))
        pushParam(calcData.beam, "Ta", lambda: float(form_data.get("Ta")))
        pushParam(calcData.beam, "Tb", lambda: float(form_data.get("Tb")))
        pushParam(calcData.beam, "Pa", lambda: float(form_data.get("Pa")))
        pushParam(calcData.beam, "Pb", lambda: float(form_data.get("Pb")))
        pushParam(calcData.beam, "Ga", lambda: float(form_data.get("Ga")))
        pushParam(calcData.beam, "Gb", lambda: float(form_data.get("Gb")))
        pushParam(calcData.beam, "N0a", lambda: float(form_data.get("N0a")))
        pushParam(calcData.beam, "N0b", lambda: float(form_data.get("N0b")))
        pushParam(calcData.beam, "dt", lambda: float(form_data.get("dt")))
        pushParam(calcData.beam, "volume", lambda: float(form_data.get("volume")))
        pushParam(calcData.beam, "initial_photons", lambda: float(form_data.get("initial_photons")))
        pushParam(calcData.beam, "cavity_loss", lambda: float(form_data.get("cavity_loss")))
        pushParam(calcData.beam, "h", lambda: float(form_data.get("h")))
        pushParam(calcData.beam, "diode_update_pulse", lambda: form_data.get("CalcDiodeUpdatePulse"))
        pushParam(calcData.beam, "diode_intensity", lambda: form_data.get("CalcDiodeSelectIntensity"))
        pushParam(calcData.beam, "diode_cavity_type", lambda: form_data.get("CalcDiodeCavityType"))
        pushParam(calcData.beam, "diode_mode", lambda: form_data.get("CalcDiodeSelectMode"))
        pushParam(calcData.beam, "beam_sampling", lambda: form_data.get("DiodeSelectSampling"))
        pushParam(calcData.beam, "beam_sampling_x", lambda: form_data.get("DiodeSelectSamplingX"))
        pushParam(calcData.beam, "start_gain", lambda: float(form_data.get("start_gain")))
        pushParam(calcData.beam, "start_absorber", lambda: float(form_data.get("start_absorber")))
        pushParam(calcData.beam, "rand_factor_seed", lambda: float(form_data.get("rand_factor_seed")))
        pushParam(calcData.beam, "kappa", lambda: float(form_data.get("kappa")))
        pushParam(calcData.beam, "C_loss", lambda: float(form_data.get("C_loss")))
        pushParam(calcData.beam, "C_gain", lambda: float(form_data.get("C_gain")))
        pushParam(calcData.beam, "coupling_out_loss", lambda: float(form_data.get("coupling_out_loss")))
        pushParam(calcData.beam, "coupling_out_gain", lambda: float(form_data.get("coupling_out_gain")))
    except:
        pass

    try:
        pushParam(calcData.beam, "beam_view_from", lambda: int(form_data.get("DispersionViewFrom")))
        pushParam(calcData.beam, "beam_view_to", lambda: int(form_data.get("DispersionViewTo")))
