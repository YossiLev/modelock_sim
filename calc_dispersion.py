...
class dispersion_calc(CalcCommonBeam):
    def __init__(self):
        ...
        self.dispersion_past = np.zeros((5, 1000), dtype=np.complex128)
            ...
            Div(
                Div(
                    ...
                    generate_chart([cget(self.dispersion_t_list).tolist()], 
                                    [cget(pulse).tolist()], 
                                    "Pulse in (photons/sec)", color=["red"], twinx=True),
                    # Div(
                    ...
                    generate_chart([t_list], 
                                    ...
                                    "E", color=["green", "red"], lw=[1, 3], twinx=True),
                    ...
                    generate_chart([t_list], 
                                    ...
                                    "Using FFT", color=["green", "red"], lw=[1, 3], twinx=True),
                    generate_chart([t_list], 
                                    ...
                                    "Using FD S3", color=["green", "red"], lw=[1, 3], twinx=True),
                    generate_chart([t_list], 
                                    ...
                                    "Using FD S5", color=["green", "red"], lw=[1, 3], twinx=True),
                    # generate_chart([t_list], 
                    ...
                    #                 "Using FD 5 Past only", color=["green", "red"], lw=[1, 3], twinx=True),
                    # generate_chart([t_list], 
                    ...
                    #                 "Using Past Memory", color=["green", "red"], lw=[1, 3], twinx=True),
