...
def generate_multi_on_server(data_obj):
    ...
    return Div(
        ...
        Div(
            ...
            Button("Restore Parameters", onclick="restoreMultiTimeParametersProcess('multiTimeOptionsForm')"),
            Div(Div("Give a name to saved parameters"),
                ...
                Button("Save", onclick="saveMultiTimeParameters(1, 'multiTimeOptionsForm')"),
                Button("Cancel", onclick="saveMultiTimeParameters(0, 'multiTimeOptionsForm')"),
            ...
            Div(Div("Select the parameters set"),
                ...
                Button("Cancel", onclick="restoreMultiTimeParameters(-1, 'multiTimeOptionsForm')"),
