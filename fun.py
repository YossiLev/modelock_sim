    ...
    return Div(
        ...
        Div(
            Div(
                ...
                InputS('initialRange', "The range of the wave front (meters)", f'{params["initialRange"]}', step=0.0001, width = 80),
                InputS('seed', "Random seed", f'{params["seed"]}', step="", width = 50),
                InputS('aperture', "Width of a Gaussian aperture (meters)", f'{params["aperture"]}', step=0.00001, width = 50),
                InputS('diffractionWaist', "Width of a diffraction (meters)", f'{params["diffractionWaist"]}', step=0.00001, width = 50),
                InputS('epsilon', "Gain Epsilon", f'{params["epsilon"]}', step=0.01,),
